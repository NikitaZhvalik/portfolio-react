    ...
    return (
        <div className="about">
            ...
            <p className="about__text">
                Front-end разработчик, ориентированный на результат. Создаю
                SPA приложения с использованием React. Ищу работу на постоянной основе в компании с современным подходом к
